...
public abstract class AbstractBidGenerator implements BidGenerator {
  ...
  public void checkRedisInstanceParam(IdConfig idConfig, DistributedIncrAssigner incrAssigner) {
  ...
  public void checkIdConfig(IdConfig idConfig, Long tenantId) {
