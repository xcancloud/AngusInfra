 ...
 * point with all beans that implement {@code JobExecutor}, keyed by their bean name.  This registry
 * exposes a safe lookup that throws a clear {@link IllegalArgumentException} when an unknown name
 * is requested, preventing external callers from directing the framework toward arbitrary Spring
 * beans (CWE-470).
 *
