...
/**
 * Base class for plugin-provided controller components. Plugins may extend this class to obtain
 * access to the plugin's {@link PluginContext} and convenience helpers such as logging and service
 * lookup.
 */
