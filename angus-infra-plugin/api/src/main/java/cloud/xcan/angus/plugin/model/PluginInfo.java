 ...
 * <p>
 * Contains metadata such as id/name/version, lifecycle timestamps, controller endpoint counts and
 * other optional fields useful for management UIs.
 */
@Setter
@Getter
public class PluginInfo {
  ...
  /**
   * Obtain a new {@link Builder} instance to construct a {@link PluginInfo} object.
   *
