...
import static cloud.xcan.angus.remote.message.http.GatewayTimeout.M.GATEWAY_TIMEOUT;
import static cloud.xcan.angus.remote.message.http.GatewayTimeout.M.GATEWAY_TIMEOUT_KEY;
