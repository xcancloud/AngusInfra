...
public class DefaultVersionManager implements VersionManager {
   ...
   * {@code ">=1.4.0 & <1.6.0"} (range). See
   * https://github.com/zafarkhaja/jsemver#semver-expressions-api-ranges for more info.
   */
  @Override
  public boolean checkVersionConstraint(String version, String constraint) {
    return StringUtils.isNullOrEmpty(constraint)
        || Version.valueOf(/*Fix::Ignore -SNAPSHOT*/
            Version.valueOf(version).getNormalVersion())
