...
public class VersionParser implements Parser<Version> {
   ...
   */
  public static enum CharType implements TypeStream.ElementType<Character> {
     ...
     */
    public static CharType forCharacter(Character chr) {
   ...
   */
  private final TypeStream<Character> chars;
  ...
  public VersionParser(String input) {
    ...
    chars = new TypeStream<Character>(elements);
  }
  ...
  /**
   * Parses the {@literal <valid cloud.xcan.angus.spec.version.semver>} non-terminal.
   *
   * <pre>
   * {@literal
   * <valid cloud.xcan.angus.spec.version.semver> ::= <version core>
