...
public class CacheProperties {
  ...
  public static class MemoryCacheProperties {
    ...
    /**
     * Retained for API compatibility; no longer drives Caffeine eviction.
     * Caffeine uses per-entry TTL derived from each entry's expireAt timestamp.
     */
  ...
  public static class ManagementProperties {
    ...
    /**
     * Whether to expose the cache management REST API under {@code /api/v1/cache}.
     * Disabled by default — enable only in trusted / internal environments and always
     * protect the endpoints with authentication (e.g. Spring Security).
     */
