...
public class CacheManagementController {
  ...
  @Operation(operationId = "listCacheEntries", summary = "List active cache entries with pagination", description = "Returns paginated active (non-expired) cache entries with their metadata (key, timestamps, TTL). Values are not included for performance.")
  @GetMapping("/entries")
  public ApiLocaleResult<Page<CacheEntryInfo>> listEntries(
    ...
    return ApiLocaleResult.success(cache.listEntries(pageNo, pageSize));
  }
