...
<dependency>
  ...
  <artifactId>xcan-infra.core-base</artifactId>
...
- `xcan-infra.core` - 完整的 core 模块（聚合所有子模块）
- `xcan-infra.persistence-jpa-starter` - JPA 持久化
- `xcan-infra.persistence-jdbc-starter` - JDBC 持久化
- `xcan-infra.feign-integration-starter` - Feign 远程调用
