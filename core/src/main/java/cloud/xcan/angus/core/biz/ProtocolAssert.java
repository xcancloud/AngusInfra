...
import static cloud.xcan.angus.remote.message.ProtocolException.M.RESOURCE_ID_EMPTY;
...
public class ProtocolAssert {
  ...
  public static <ID> void assertIdNotEmpty(ID id) {
    if (id == null || (id instanceof String && isEmpty((String) id))) {
      throw ProtocolException.of(RESOURCE_ID_EMPTY);
    }
  }

  public static <T> void assertNotEmpty(T object) {
    if (isEmpty(object)) {
      throw ProtocolException.of(OPT_OBJ_IS_EMPTY);
    }
  }

  public static <T> void assertNotEmpty(T object, String message) {
    if (isEmpty(object)) {
      throw ProtocolException.of(StringUtils.isNotEmpty(message) ? message : OPT_OBJ_IS_EMPTY);
    }
  }
  ...
  public static <T> void assertNotEmpty(T object, ResultMessage message) {
    if (isEmpty(object)) {
      throw ProtocolException.of(message.getCode(), message.getMsg(), message.getArgs());
    }
  }

  public static <T> void assertNotEmpty(T object, ResultMessage message, ExceptionLevel level) {
    if (isEmpty(object)) {
      throw ProtocolException.of(message.getCode(), message.getMsg(), level);
    }
  }
  ...
  public static <T> void assertNotNull(T object, String message, ExceptionLevel level) {
    if (object == null) {
      throw ProtocolException.of(message, level);
    }
  }
  ...
  public static <T> void assertNotNull(T object, String message, Object[] args,
    ...
    if (object == null) {
      throw ProtocolException.of(message, args, level);
    }
  }

  public static <T> void assertNotNull(T object, ResultMessage message) {
    if (object == null) {
      throw ProtocolException.of(message.getCode(), message.getMsg());
    }
  }
