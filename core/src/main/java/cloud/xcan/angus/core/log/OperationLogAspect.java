...
import static cloud.xcan.angus.core.utils.PrincipalContextUtils.isCmdRequest;
import static cloud.xcan.angus.core.utils.PrincipalContextUtils.isDeleteRequest;
import static cloud.xcan.angus.core.utils.PrincipalContextUtils.isGetRequest;
import static cloud.xcan.angus.core.utils.PrincipalContextUtils.isPatchRequest;
import static cloud.xcan.angus.core.utils.PrincipalContextUtils.isPostRequest;
import static cloud.xcan.angus.core.utils.PrincipalContextUtils.isPutRequest;
...
import cloud.xcan.angus.spec.experimental.BizConstant.UserKey;
...
public class OperationLogAspect {
  ...
  @Pointcut("@annotation(cloud.xcan.angus.core.log.OperationLog)")
  ...
  private void setSuccessResult(ApiLocaleResult<?> apiResult, UserOperation operationTemplate) {
    ...
    if (apiResult.isSuccess()) {
      ...
      operationTemplate.setSuccess(false).setFailureReason(apiResult.getMessage());
    }
  }
