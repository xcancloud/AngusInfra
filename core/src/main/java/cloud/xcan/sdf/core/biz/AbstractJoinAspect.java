...
import static cloud.xcan.sdf.api.ApiConstant.LCS_PUB;
...
public abstract class AbstractJoinAspect {
  ...
  public static String writePublicFileWhenNotExists() {
    ...
    try {
      ...
      System.out.println(
          new cloud.xcan.sdf.api.obf.Str0(new long[]{0x8B60B722C3C6EF28L, 0xD4DEF5A0D5325EEBL, 0x2E744FB20DEFC5A9L,
