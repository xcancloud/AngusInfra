...
package cloud.xcan.sdf.core.exception;


import static cloud.xcan.sdf.api.ApiConstant.ECode.BUSINESS_ERROR_EVENT_CODE;
import static cloud.xcan.sdf.api.ApiConstant.ECode.PROTOCOL_ERROR_EVENT_CODE;
import static cloud.xcan.sdf.api.ApiConstant.ECode.QUOTA_ERROR_EVENT_CODE;
import static cloud.xcan.sdf.api.ApiConstant.ECode.SECURITY_FORBIDDEN_EVENT_CODE;
import static cloud.xcan.sdf.api.ApiConstant.ECode.SECURITY_UNAUTHORIZED_EVENT_CODE;
import static cloud.xcan.sdf.api.ApiConstant.ECode.SYSTEM_ERROR_EVENT_CODE;
import static cloud.xcan.sdf.api.ApiConstant.EXT_EKEY_NAME;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_BINDING_ERROR;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_BINDING_ERROR_KEY;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_BINDING_ERROR_T;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_BINDING_ERROR_T2;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_MISSING;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_MISSING_KEY;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_PARSING_ERROR;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_PARSING_ERROR_KEY;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_VALIDATION_ERROR;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_VALIDATION_ERROR_KEY;
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PARAM_VALIDATION_ERROR_T;
import static cloud.xcan.sdf.api.message.CommSysException.M.DATABASE_ACCESS_EXCEPTION;
import static cloud.xcan.sdf.api.message.CommSysException.M.DATABASE_ACCESS_EXCEPTION_KEY;
import static cloud.xcan.sdf.api.message.CommSysException.M.DATABASE_API_EXCEPTION;
import static cloud.xcan.sdf.api.message.CommSysException.M.DATABASE_API_EXCEPTION_KEY;
import static cloud.xcan.sdf.api.message.CommSysException.M.DATABASE_INTEGRITY_EXCEPTION;
import static cloud.xcan.sdf.api.message.CommSysException.M.DATABASE_INTEGRITY_EXCEPTION_KEY;
...
import static cloud.xcan.sdf.api.message.http.MediaTypeNotSupported.M.MEDIA_TYPE_NOT_SUPPORTED;
import static cloud.xcan.sdf.api.message.http.MediaTypeNotSupported.M.MEDIA_TYPE_NOT_SUPPORTED_KEY;
import static cloud.xcan.sdf.api.message.http.MediaTypeNotSupported.M.MEDIA_TYPE_NOT_SUPPORTED_T;
...
import static cloud.xcan.sdf.api.message.http.MethodNotSupported.M.METHOD_NOT_ALLOWED_T;
import static cloud.xcan.sdf.api.message.http.ResourceNotFound.MKey.HANDLER_NOT_FOUND_KEY;
import static cloud.xcan.sdf.api.message.http.ResourceNotFound.MKey.HANDLER_NOT_FOUND_T;
import static cloud.xcan.sdf.api.message.http.Unauthorized.M.UNAUTHORIZED_KEY;
import static cloud.xcan.sdf.core.utils.EventUtils.assembleExceptionEvent;
import static cloud.xcan.sdf.spec.principal.PrincipalContext.getDefaultLanguage;
...
import cloud.xcan.sdf.api.message.UnknownException;
...
import cloud.xcan.sdf.core.event.CommonEvent;
 ...
 *
 * @author XiaoLong Liu
 * @see ResponseEntityExceptionHandler#handleException(java.lang.Exception, WebRequest)
...
public class DefaultGlobalExceptionAdvice {
  ...
  public ApiResult<?> handleException(java.lang.Exception e, HttpServletResponse response) {
