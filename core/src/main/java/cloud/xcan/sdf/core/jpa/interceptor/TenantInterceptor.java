package cloud.xcan.sdf.core.jpa.interceptor;
...
import static cloud.xcan.sdf.spec.experimental.BizConstant.TENANT_ID_DB_KEY;
...
public class TenantInterceptor implements StatementInspector {
  ...
  public TenantInterceptor() {
    if (CollectionUtils.isEmpty(TENANT_TABLES)) {
      TENANT_TABLES = loadAnnotationTable("cloud.xcan.sdf", MultiTenant.class);
    }
  }
