...
import static cloud.xcan.sdf.core.utils.CoreUtils.getAnnotationClasses;
import static cloud.xcan.sdf.core.utils.PrincipalContextUtils.getOptTenantId;
import static cloud.xcan.sdf.core.utils.PrincipalContextUtils.hasRealOptTenantId;
import static cloud.xcan.sdf.core.utils.PrincipalContextUtils.hasToPolicy;
...
import cloud.xcan.sdf.core.jpa.repository.summary.Aggregate;
import cloud.xcan.sdf.core.jpa.repository.summary.DateRangeType;
import cloud.xcan.sdf.core.jpa.repository.summary.GroupBy;
...
public class SimpleSummaryRepository implements SummaryRepository {
  ...
  public SimpleSummaryRepository() {
    if (CollectionUtils.isEmpty(REGISTER)) {
      REGISTER = loadAnnotation("cloud.xcan.sdf", SummaryQueryRegister.class);
    }
  }
