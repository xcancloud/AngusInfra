...
import static cloud.xcan.sdf.api.ApiConstant.ApiLog.CLEAR_BEFORE_DAY;
import static cloud.xcan.sdf.api.ApiConstant.ApiLog.DEFAULT_IGNORE_PATTERN;
...
import cloud.xcan.sdf.api.ApiConstant.ApiLog;
import cloud.xcan.sdf.api.ApiConstant.Service;
import cloud.xcan.sdf.api.enums.PrintLevel;
import cloud.xcan.sdf.core.app.AppPropertiesRegister;
...
public class ApiLogProperties implements AppPropertiesRegister {
  ...
  public static class SystemRequest implements AppPropertiesRegister {
    ...
    /**
     * Record the logs of system token from: {@link cloud.xcan.sdf.spec.experimental.BizConstant.ClientSource#XCAN_SYS_TOKEN}
     */
