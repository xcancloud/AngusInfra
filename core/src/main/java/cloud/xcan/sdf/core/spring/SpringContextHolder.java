...
package cloud.xcan.sdf.core.spring;

import static cloud.xcan.sdf.core.biz.AbstractJoinAspect.writePublicFileWhenNotExists;

import cloud.xcan.sdf.core.spring.boot.ApplicationInfo;
import cloud.xcan.sdf.idgen.bid.impl.DefaultBidGenerator;
...
public class SpringContextHolder implements ApplicationContextAware {
  ...
  public static DCache getDCache(String no, String path) throws Exception {
    ...
    DCacheParamImpl licenseParam = new DCacheParamImpl(
        new cloud.xcan.sdf.api.obf.Str0( // Same with cloud.xcan.sdf.License.SUBJECT
        new long[]{0x1E6B43C60AC22C6DL, 0x8423C94847116C1AL, 0xC4EE5C2A8A84EAB2L,
            0xD27DB35290719CD5L}).toString() /* => "XCan Product License" */, keyStoreParam, cipherParam);
