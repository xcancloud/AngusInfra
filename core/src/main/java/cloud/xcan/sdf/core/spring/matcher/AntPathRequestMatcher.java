...
package cloud.xcan.sdf.core.spring.matcher;
...
/**
 * Matcher which compares a pre-defined ant-style pattern against the URL ( {@code servletPath +
 * pathInfo}) of an {@code HttpServletRequest}. The query string of the URL is ignored and matching
 * is case-insensitive or case-sensitive depending on the arguments passed into the constructor.
 * <p>
 ...
 * optimized by using a substring match &mdash; a pattern of {@code /aaa/**} will match {@code
 * /aaa}, {@code /aaa/} and any sub-directories, such as {@code /aaa/bbb/ccc}.
 * </p>
 * <p>
...
public final class AntPathRequestMatcher implements RequestMatcher {
  ...
  public AntPathRequestMatcher(String pattern, String httpMethod, boolean caseSensitive,
    ...
    this.httpMethod = StringUtils.hasText(httpMethod) ? org.springframework.http.HttpMethod.valueOf(httpMethod) : null;
   ...
   *
   * @param request the request to match against. The ant pattern will be matched against the {@code
   *                servletPath} + {@code pathInfo} of the request.
   */
  @Override
