...
public interface RequestMatcher {
  ...
  /**
   * Returns a MatchResult for this RequestMatcher The default implementation returns {@link
   * Collections#emptyMap()} when {@link MatchResult#getVariables()} is invoked.
   *
  ...
  /**
   * The result of matching against an HttpServletRequest Contains the status, true or false, of the
   * match and if present, any variables extracted from the match
   *
   * @since 5.2
   */
  class MatchResult {
    ...
    /**
     * Returns the extracted variable values where the key is the variable name and the value is the
     * variable value
     *
     * @return a map containing key-value pairs representing extracted variable names and variable
     * values
     */
