package cloud.xcan.sdf.datasource.config;
...
public class DataSourceProperties implements BeanClassLoaderAware, InitializingBean {
   ...
   *
   * @return a {@link DataSourceBuilder} initialized with the customizations defined on this
   * instance
   */
  ...
  public String determineUrl() {
    ...
    String url =
        (databaseName != null) ? this.embeddedDatabaseConnection.getUrl(databaseName) : null;
  ...
  /**
   * Allows the DataSource to be managed by the container and obtained via JNDI. The {@code URL},
   * {@code driverClassName}, {@code username} and {@code password} fields will be ignored when
   * using JNDI lookups.
   *
