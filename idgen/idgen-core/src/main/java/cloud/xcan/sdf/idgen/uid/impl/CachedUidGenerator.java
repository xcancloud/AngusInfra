...
package cloud.xcan.sdf.idgen.uid.impl;
...
import cloud.xcan.sdf.idgen.uid.BitsAllocator;
import cloud.xcan.sdf.idgen.uid.buffer.BufferPaddingExecutor;
import cloud.xcan.sdf.idgen.uid.buffer.RejectedPutBufferHandler;
import cloud.xcan.sdf.idgen.uid.buffer.RejectedTakeBufferHandler;
import cloud.xcan.sdf.idgen.uid.buffer.RingBuffer;
 ...
 * <li><b>scheduleInterval:</b> Padding buffer in a schedule, specify padding buffer interval, ValueUnit
 * as second
