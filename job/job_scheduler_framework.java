...
setJobType(JobType.SHARDING);
shardingJob.

setBeanName("emailShardingJob");
shardingJob.

setShardingCount(5); // 5个分片
shardingJob.

setShardingParameter("region1,region2,region3,region4,region5");
shardingJob.

setDescription("批量发送邮件通知");

jobManagementService.

createJob(shardingJob);
*/
