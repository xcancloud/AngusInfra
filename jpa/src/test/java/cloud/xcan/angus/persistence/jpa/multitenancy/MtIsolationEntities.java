...
/**
 * Test-only JPA types for multitenancy metadata / {@link TenantMetadata#isMultiTenantEntity}
 * checks (under {@code cloud.xcan.angus} so they participate in normal scans when loaded).
 */
