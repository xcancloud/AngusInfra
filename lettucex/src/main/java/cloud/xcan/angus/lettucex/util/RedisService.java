...
public class RedisService<T> {
  ...
  /**
   * Overwrite parts of {@code key} starting at the specified {@code offset} with given
   * {@code value}.
   */
  ...
  /**
   * Increment a floating point number value stored as string value under {@code key} by
   * {@code delta}.
   */
  ...
  /**
   * Intersect all given sets at {@code key} and {@code otherKey} and store result in
   * {@code destKey}.
   */
  ...
  /**
   * Intersect all given sets at {@code key} and {@code otherKeys} and store result in
   * {@code destKey}.
   */
  ...
  /**
   * Get set of {@link TypedTuple}s where score is between {@code min} and {@code max} from sorted
   * set.
   */
  ...
  /**
   * Get set of {@link TypedTuple}s in range from {@code start} to {@code end} where score is
  ...
  /**
   * Get set of {@link TypedTuple}s in range from {@code start} to {@code end} from sorted set
  ...
  /**
   * Get set of {@link TypedTuple} where score is between {@code min} and {@code max} from sorted
  ...
  /**
   * Remove elements in range between {@code start} and {@code end} from sorted set with
   * {@code key}.
   */
  ...
  /**
   * Remove elements with scores between {@code min} and {@code max} from sorted set with
   * {@code key}.
   */
  ...
  /**
   * Union sorted sets at {@code key} and {@code otherKeys} and store result in destination
   * {@code destKey}.
   */
