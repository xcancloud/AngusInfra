...
<dependency>
  ...
  <artifactId>xcan-infra.persistence-jdbc-starter</artifactId>
...
- `xcan-infra.core-base` - 核心基础（必需）
- `xcan-infra.persistence-jpa-starter` - JPA 持久化（可选）
- `xcan-infra.datasource` - 数据源管理（可选）
