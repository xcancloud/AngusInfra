 ...
 * <p>
 * Implementations are responsible for discovering, loading, starting, stopping and unloading plugin
 * artifacts. The manager also exposes management operations such as installing plugin bytes into
 * storage and removing plugins.
 */
public interface PluginManager {

  /**
   * Initialize the plugin manager. This should create necessary directories and prepare internal
   * data structures; it does not necessarily load plugins.
   */
  void initialize();
   ...
   * Implementations should persist the bytes according to the configured PluginStore and then call
   * the loading routine.
   *
   * @param pluginId plugin identifier
