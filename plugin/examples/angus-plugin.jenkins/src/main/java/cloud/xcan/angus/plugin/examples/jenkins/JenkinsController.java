...
public class JenkinsController extends PluginController {
  ...
  public String triggerBuild(@RequestParam String jenkinsUrl, @RequestParam String jobName)
  ...
  public String getLastBuildStatus(@RequestParam String jenkinsUrl, @RequestParam String jobName)
      throws IOException, InterruptedException {
