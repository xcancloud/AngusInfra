...
public class AdminController {
  ...
  @GetMapping("/stats")
  public ApiLocaleResult<Map<String, Object>> stats(@RequestParam @NotBlank String topic) {
    return ApiLocaleResult.success(adminService.topicStats(topic));
  }
  ...
  public ApiLocaleResult<Map<String, Object>> purgeDone(@RequestParam @NotBlank String topic,
    ...
    return ApiLocaleResult.success(Map.of("purged", n));
  }
  ...
  public ApiLocaleResult<Map<String, Object>> purgeDlq(@RequestParam @NotBlank String topic) {
