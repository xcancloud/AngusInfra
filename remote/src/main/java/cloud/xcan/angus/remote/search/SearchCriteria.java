...
public class SearchCriteria implements Serializable {
  ...
  public boolean isRangeSearch() {
    return op.equals(SearchOperation.GREATER_THAN) || op.equals(
        SearchOperation.LESS_THAN) || op
        .equals(SearchOperation.GREATER_THAN_EQUAL) || op.equals(
  ...
  public boolean isMatchSearch() {
    return op.equals(SearchOperation.MATCH) || op.equals(
  ...
  public boolean isNotMatchSearch() {
    return op.equals(SearchOperation.NOT_MATCH) || op.equals(
  ...
  public boolean isInSearch() {
    return op.equals(SearchOperation.IN) || op.equals(
  ...
  public boolean isInOrNotSearch() {
    return op.equals(SearchOperation.NOT_EQUAL) || op.equals(
        SearchOperation.IN) || op
