...
import static cloud.xcan.sdf.api.message.CommProtocolException.M.PROTOCOL_ERROR;
...
public class CommProtocolException extends AbstractResultMessageException {
  ...
  public static CommProtocolException of(String message, Object[] agrs, Throwable cause) {
    return new CommProtocolException(message, EventType.PROTOCOL, PROTOCOL_ERROR_KEY, agrs, null, cause);
  }
  ...
  public static CommProtocolException of(String message, String eKey, Object[] agrs, Throwable cause) {
