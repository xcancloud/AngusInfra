...
import static cloud.xcan.sdf.api.message.http.ResourceExisted.M.RESOURCE_ALREADY_EXISTS;
import static cloud.xcan.sdf.api.message.http.ResourceExisted.M.RESOURCE_ALREADY_EXISTS_KEY;
import static cloud.xcan.sdf.api.message.http.ResourceExisted.M.RESOURCE_ALREADY_EXISTS_T;
import static cloud.xcan.sdf.api.message.http.ResourceExisted.M.RESOURCE_ALREADY_EXISTS_T2;
...
public class ResourceExisted extends AbstractResultMessageException {
  ...
  public static ResourceExisted of(Long resId, String resName, String message,
      Object[] args, ExceptionLevel level) {
    return new ResourceExisted(String.valueOf(resId), resName, message, args, RESOURCE_ALREADY_EXISTS_KEY,
        level);
  }
