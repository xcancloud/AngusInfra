...
/**
 * Thrown if an {@link UserDetailsService} implementation cannot locate a {@link CustomOAuth2User}
 * by its account.
 */
public class AccountNotFoundException extends AuthenticationException {
  ...
  /**
   * Constructs a {@code AccountNotFoundException} with the specified message and root cause.
   *
   * @param msg   the detail message.
