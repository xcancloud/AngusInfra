...
final class CodeVerifierAuthenticator {
  ...
  private boolean authenticate(OAuth2ClientAuthenticationToken clientAuthentication,
    ...
    OAuth2Authorization authorization = this.authorizationService
        .findByToken((String) parameters.get(OAuth2ParameterNames.CODE),
    ...
    if (!StringUtils.hasText(codeChallenge)) {
      if (registeredClient.getClientSettings().isRequireProofKey() || StringUtils.hasText(
          codeVerifier)) {
  ...
  private boolean codeVerifierValid(String codeVerifier, String codeChallenge,
