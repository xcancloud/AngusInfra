...
CREATE TABLE IF NOT EXISTS angus_shard_table (
    table_name  VARCHAR(255) NOT NULL COMMENT 'Fully-qualified sharded table name, e.g. exec_sample-100-3',
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = 'Registry of physically-created shard tables';
