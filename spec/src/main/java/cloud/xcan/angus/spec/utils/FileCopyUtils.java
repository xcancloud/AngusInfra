...
public final class FileCopyUtils {
  ...
  private FileCopyUtils() { /* no instance */ }
  ...
  public static int copy(File in, File out) throws IOException {
    Assert.assertNotNull(in, "No input File specified");
    Assert.assertNotNull(out, "No output File specified");
  ...
  public static int copy(Reader in, Writer out) throws IOException {
    Assert.assertNotNull(in, "No Reader specified");
    Assert.assertNotNull(out, "No Writer specified");
