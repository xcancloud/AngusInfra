...
/**
 * Modification on {@link TimeUnit#convert(long, TimeUnit)} that accepts and preserves precision
 * from a {@code double} argument.
 */
public final class TimeUtils {
  ...
  public static Duration simpleParse(String time) {
    ...
    if (timeLower.endsWith("ns")) {
      ...
      return Duration
          .of(Long.parseLong(timeLower.substring(0, timeLower.length() - 1)), ChronoUnit.DAYS);
    }
