...
/**
 * An unmodifiable view of a {@code Map<T, List<U>>}.
 */
public class UnmodifiableMapOfLists<T, U> implements Map<T, List<U>>, Serializable {
  ...
  public UnmodifiableMapOfLists(Map<T, List<U>> delegate) {
  ...
  @Override
  public List<U> computeIfPresent(T key,
      BiFunction<? super T, ? super List<U>, ? extends List<U>> remappingFunction) {
    throw new UnsupportedOperationException();
  }

  @Override
  public List<U> compute(T key,
      BiFunction<? super T, ? super List<U>, ? extends List<U>> remappingFunction) {
    throw new UnsupportedOperationException();
  }
  ...
  private static class UnmodifiableEntrySet<T, U> implements Set<Entry<T, List<U>>> {
    ...
    public void forEach(Consumer<? super Entry<T, List<U>>> action) {
      delegate.forEach(e -> action
          .accept(new SimpleImmutableEntry<>(e.getKey(), unmodifiableList(e.getValue()))));
    }
