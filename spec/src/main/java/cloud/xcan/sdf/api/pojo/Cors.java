...
public class Cors {
  ...
  /**
   * @see cloud.xcan.sdf.spec.http.HttpResponseHeader#Access_Control_Allow_Origin
   */
  ...
  /**
   * @see cloud.xcan.sdf.spec.http.HttpResponseHeader#Access_Control_Allow_Credentials
   */
  ...
  /**
   * @see cloud.xcan.sdf.spec.http.HttpResponseHeader#Access_Control_Allow_Headers
   */
  @Length(max = DEFAULT_PARAM_VALUE_LENGTH)
  ...
  /**
   * @see cloud.xcan.sdf.spec.http.HttpResponseHeader#Access_Control_Allow_Methods
   */
  @Length(max = DEFAULT_PARAM_VALUE_LENGTH)
  ...
  /**
   * @see cloud.xcan.sdf.spec.http.HttpResponseHeader#Access_Control_Expose_Headers
   */
  @Length(max = DEFAULT_PARAM_VALUE_LENGTH)
