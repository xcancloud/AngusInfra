 ...
 *
 * @see <a href="https://www.iana.org/assignments/http-status-codes">HTTP HealthStatus Code Registry</a>
...
public enum HttpStatus implements EnumMessage<String> {
   ...
   * 10.4.15</a> deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code
   ...
   *
   * @see <a href="https://tools.ietf.org/html/rfc6585#section-3">Additional HTTP HealthStatus Codes</a>
   */
  PRECONDITION_REQUIRED(428, HttpStatusSeries.CLIENT_ERROR, "Precondition Required"),
  /**
   * {@code 429 Too Many Requests}.
   *
   * @see <a href="https://tools.ietf.org/html/rfc6585#section-4">Additional HTTP HealthStatus Codes</a>
   */
  TOO_MANY_REQUESTS(429, HttpStatusSeries.CLIENT_ERROR, "Too Many Requests"),
  /**
   * {@code 431 Request Header Fields Too Large}.
   *
   * @see <a href="https://tools.ietf.org/html/rfc6585#section-5">Additional HTTP HealthStatus Codes</a>
   */
   ...
   *
   * @see <a href="https://tools.ietf.org/html/rfc6585#section-6">Additional HTTP HealthStatus Codes</a>
   */
  ...
  /**
   * Whether this status code is in the HTTP series {@link HttpStatusSeries#CLIENT_ERROR} or {@link
   * HttpStatusSeries#SERVER_ERROR}.
   * <p>This is a shortcut for checking the value of {@link #series()}.
   *
