...
public class TimeWindowMovingCurrent implements MovingCurrent {
  ...
  /**
   * Creates a new {@link TimeWindowMovingCurrent}.
   */
  public TimeWindowMovingCurrent() {
   ...
   */
  public TimeWindowMovingCurrent(Clock clock) {
    this.clock = clock;
