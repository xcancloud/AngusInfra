...
public interface SystemSetting {
  ...
  /**
   * Attempt to load a system setting from {@link System#getProperty(String)} and {@link
   * System#getenv(String)}. This should be used in favor of those methods because the SDK should
   * support both methods of configuration.
   * <p>
