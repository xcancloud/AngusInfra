...
import static cloud.xcan.sdf.spec.utils.ObjectUtils.firstPresent;
...
public final class SystemSettingUtils {
  ...
  /**
   * Convert a string to boolean safely (as opposed to the less strict {@link
   * Boolean#parseBoolean(String)}). If a customer specifies a boolean value it should be "true" or
   * "false" (case insensitive) or an exception will be thrown.
   */
