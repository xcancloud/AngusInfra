...
public class DirectedGraph<V> {
  ...
  /**
   * Report (as a Map) the out-degree (the number of tail ends adjacent to a vertex) of each
   * vertex.
   */
  ...
  /**
   * Report (as a {@link Map}) the in-degree (the number of head ends adjacent to a vertex) of each
   * vertex.
   */
  ...
  /**
   * Report (as a List) the topological sort of the vertices; null for no such sort. See <a
   * href="https://en.wikipedia.org/wiki/Topological_sorting">this</a> for more information.
   */
