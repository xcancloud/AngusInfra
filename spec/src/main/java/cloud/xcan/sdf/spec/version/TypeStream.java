 ...
 * @see cloud.xcan.sdf.spec.version.VersionParser
 * @see cloud.xcan.sdf.spec.version.expr.Lexer
 * @see cloud.xcan.sdf.spec.version.expr.ExpressionParser
 */
public class TypeStream<E> implements Iterable<E> {
   ...
   *
   * @param <T>      represents the element type of this stream, removes the "unchecked generic
   *                 array creation for varargs parameter" warnings
