...
import cloud.xcan.sdf.spec.version.expr.ExpressionParser;
import cloud.xcan.sdf.spec.version.expr.LexerException;
import cloud.xcan.sdf.spec.version.expr.UnexpectedTokenException;
...
public class Version implements Comparable<Version> {
   ...
   *
   * @param other the other version to compare to
   * @return {@code true} if this version is greater than or equal to the other version or {@code
   * false} otherwise
   * @see #compareTo(Version other)
   */
   ...
   *
   * @param other the other version to compare to
   * @return {@code true} if this version is less than or equal to the other version or {@code
   * false} otherwise
   * @see #compareTo(Version other)
   */
   ...
   * versions' build metadata use the {@code Version.compareWithBuildsTo} method or the {@code
