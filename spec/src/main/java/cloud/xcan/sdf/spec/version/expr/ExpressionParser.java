...
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.CARET;
...
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.LEFT_PAREN;
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.NOT;
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.NUMERIC;
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.OR;
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.RIGHT_PAREN;
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.TILDE;
import static cloud.xcan.sdf.spec.version.expr.Lexer.Token.Type.WILDCARD;

import cloud.xcan.sdf.spec.version.Parser;
import cloud.xcan.sdf.spec.version.TypeStream;
import cloud.xcan.sdf.spec.version.TypeStream.ElementType;
import cloud.xcan.sdf.spec.version.UnexpectedElementException;
...
public class ExpressionParser implements Parser<Expression> {
  ...
  /**
   * Parses the {@literal <cloud.xcan.sdf.spec.version.semver-expr>} non-terminal.
   *
   * <pre>
   * {@literal
   * <cloud.xcan.sdf.spec.version.semver-expr> ::= "(" <cloud.xcan.sdf.spec.version.semver-expr> ")"
   *                 | "!" "(" <cloud.xcan.sdf.spec.version.semver-expr> ")"
   *                 | <cloud.xcan.sdf.spec.version.semver-expr> <more-expr>
   *                 | <range>
   * }
   * </pre>
   *
   ...
   * <pre>
   * {@literal
   * <more-expr> ::= <boolean-op> <cloud.xcan.sdf.spec.version.semver-expr> | epsilon
   * }
   * </pre>
   *
   ...
   * non-terminal.
   *
   * @return {@code true} if the following version terminals are part of the {@literal
   * <wildcard-range>} non-terminal or {@code false} otherwise
   */
   ...
   *
   * @return {@code true} if the following version terminals are part of the {@literal
   * <hyphen-range>} non-terminal or {@code false} otherwise
   */
   ...
   *
   * @return {@code true} if the following version terminals are part of the {@literal
   * <partial-version-range>} non-terminal or {@code false} otherwise
   */
