...
public class Example {
  ...
  public static String format$ref(String $ref) {
    if ($ref != null && ($ref.indexOf('.') == -1 && $ref.indexOf('/') == -1)) {
      return Components.COMPONENTS_EXAMPLES_REF + $ref;
    }
    return $ref;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (description != null ? !description.equals(example.description)
    ...
    if (externalValue != null ? !externalValue.equals(example.externalValue)
