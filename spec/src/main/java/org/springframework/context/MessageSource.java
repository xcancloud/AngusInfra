...
public interface MessageSource {
   ...
   *                       users are encouraged to base message names on qualified class or package
   *                       names, avoiding potential conflicts and ensuring maximum clarity.
   ...
   *               encouraged to base message names on qualified class or package names, avoiding
   *               potential conflicts and ensuring maximum clarity.
   ...
   * @throws Exception if no corresponding message was found
   * @see #getMessage(MessageSourceResolvable, Locale)
   * @see java.text.MessageFormat
   */
